...
/**
 AnimatedTextField is a subclass of the TextFieldEffects object, is a control that displays an UITextField with a customizable visual effect around the lower edge of the control.
 */
@IBDesignable open class AnimatedTextField: TextFieldEffects {
    /**
    ...
    private let borderThickness: (active: CGFloat, inactive: CGFloat) = (active: 2, inactive: 0.8)
